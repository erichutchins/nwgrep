...
def _detect_backend(df_native: Any) -> str:
    ...
    module = type(df_native).__module__.split(".")[0]
    if module == "pandas":
        return "pandas"
    if module == "polars":
        return "polars"
...
def nwgrep(
    ...
    *,
    ...
    if highlight:
        ...
        # Note: patterns may be transformed (e.g., by whole_word), and regex/exact
        # flags should reflect the actual matching logic used
