...
### :simple-google: Google Antigravity
...
### :simple-zedindustries: Zed Editor with Claude
...
[github.com/laurigates/claude-plugins](https://github.com/laurigates/claude-plugins)
...
| ------------------- | ------------------------- | ----------------------------------------------------------------------------------- |
| **uv**              | Python package management | [docs.astral.sh/uv](https://docs.astral.sh/uv)                                      |
| **ruff**            | Linting and formatting    | [docs.astral.sh/ruff](https://docs.astral.sh/ruff/)                                 |
| **ty**              | Python type checker       | [docs.astral.sh/ty](https://docs.astral.sh/ty/)                                     |
| **pytest**          | Testing framework         | [docs.pytest.org](https://docs.pytest.org/)                                         |
| **just**            | Command runner            | [just.systems](https://just.systems/)                                               |
| **prek**            | Better pre-commit         | [prek.j178.dev](https://prek.j178.dev/)                                             |
| **mkdocs-material** | Documentation             | [squidfunk.github.io/mkdocs-material](https://squidfunk.github.io/mkdocs-material/) |
